  ...
  <body>
    ...
    <div class="content-area">
      ...
      <div class="feed-section">
        <h3>Updates & Feed</h3>
        <div class="feed-post">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSds80y3C6IPtHGw9uHTlKCrmCAZhaTlxloqg&s" alt="Post Image 1">
          <div class="form-group">
        ...
        <div class="feed-post">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1__Pwe0ZHGgtyPI3OWWlPpeZi1iDrzNg8nQ&s" alt="Post Image 2">
          <div class="form-group">
            <input type="text" placeholder="Comments..">
            <button class="comment-button">Send</button>
            <i class="fa-solid fa-comment"></i>
        ...
        <div class="feed-post">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ1__Pwe0ZHGgtyPI3OWWlPpeZi1iDrzNg8nQ&s" alt="Post Image 3">
          <div class="form-group">
            <input type="text" placeholder="Comments..">
            <button class="comment-button">Send</button>
            <i class="fa-solid fa-comment"></i>
        ...
        <div class="feed-post">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSds80y3C6IPtHGw9uHTlKCrmCAZhaTlxloqg&s" alt="Post Image 4">
          <div class="form-group">
            <input type="text" placeholder="Comments..">
            <button class="comment-button">Send</button>
            <i class="fa-solid fa-comment"></i>
